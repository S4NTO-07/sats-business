/**
 * satuno-widget.js — SATUNO Business
 * 
 * Usage (auto-detect):
 *   <script src="satuno-widget.js" data-currency="MXN"></script>
 *
 * Usage (manual):
...
(function() {
  ...
  var scriptTag = document.currentScript ||
    document.querySelector('script[src*="satuno-widget"]');
  ...
  function injectStyles() {
    if (document.getElementById('satuno-widget-styles')) return;
    var style = document.createElement('style');
    style.id  = 'satuno-widget-styles';
    var c = CONFIG.color;
    style.textContent = [
